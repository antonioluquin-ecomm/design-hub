...
- [ ] Carrito / checkout
- [ ] Vista mobile de home (solo se capturó desktop) — la PLP (`plp.html`) y la PDP (`producto-modular.html`) ya tienen su vista mobile capturada y maquetada (ver correcciones 2026-07-16 arriba)
